...
for index in range(N):
  network = _normalized_convolution(X=network, n_filters=16, kernel_shape=(3, 3), stride=(1, 1), pad=(1, 1))
  network = _normalized_convolution(X=network, n_filters=16, kernel_shape=(3, 3), stride=(1, 1), pad=(1, 1))
network = _transit(network, 32)
for index in range(N):
  network = _normalized_convolution(X=network, n_filters=32, kernel_shape=(3, 3), stride=(1, 1), pad=(1, 1))
  network = _normalized_convolution(X=network, n_filters=32, kernel_shape=(3, 3), stride=(1, 1), pad=(1, 1))
network = _transit(network, 64)
for index in range(N):
  network = _normalized_convolution(X=network, n_filters=64, kernel_shape=(3, 3), stride=(1, 1), pad=(1, 1))
  network = _normalized_convolution(X=network, n_filters=64, kernel_shape=(3, 3), stride=(1, 1), pad=(1, 1))
